    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        veriGetir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ButonGeriSayim();       //ilk geri sayım 15 saniyede bir thingspeake veri gönderebildiğimiz için butona basıldığında değeri 1 olarak kaydeder ve 15 saniye bekleyip değeri 0 a çeker bunu yapmamızın amacı arduino üzerinden 1 değerini okuyup sulamayı başlatmamız için
                ButonGeriSayim2();      //ikinci sayım 30 saniye çünkü ilk önce değeri 1 yapıp 15 saniye bekleyip 0 yaptığımız için bir 15 saniye daha thingspeake eklemek için beklemeye ihtiyacımız var
    ...
    public void BarGeriSayim(){  //Bar disable olduktan sonra enable olmasına kaç saniye kaldığını kullanıcıya göstermek için 15 den 0 a sayan bir sayaç oluşturuyorum
        new CountDownTimer(15000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                //Toast.makeText(MainActivity.this, "Değeri Yeniden Değiştirebilmek İçin Kalan Süre: " + millisUntilFinished / 1000, Toast.LENGTH_SHORT).show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            //Toast.makeText(MainActivity.this, jsnOBJ.getString("field1"), Toast.LENGTH_SHORT).show();
